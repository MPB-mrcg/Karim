...
{
    library(Rcpp)
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/bVectorHH.cpp")
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/AmatrixHH.cpp")
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/bVectorHD.cpp")
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/AmatrixHD.cpp")
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/bVectorDD.cpp")
  sourceCpp("/nfsscratch/Karim/DELGEME/isoRelate/Codes/AmatrixDD.cpp")
